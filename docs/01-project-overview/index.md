...
| **Tech Stack** | [Backend: Java (Spring Boot), REST APIs, PostgreSQL, JWT (Spring Security), 
                    Docker, GitHub Actions (CI/CD), Azure App Service. Monitoring: Spring Boot Actuator + Micrometer.
                    UI: Figma (no implemented mobile frontend yet).] |
